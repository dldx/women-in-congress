...
function second_slide() {
    ...
    slide2Group.append("text").attr("x", x(new Date(2017, 1, 1))).attr("y", y(300 / 450 * y.domain()[1])).attr("class", "men-label").text("Men").style("opacity", 0);

    // Add text label for party
    slide2Group.append("text").attr("x", x(new Date(1920, 1, 1))).attr("y", y(425 / 450 * y.domain()[1])).attr("class", "party-label").attr("alignment-baseline", "hanging").text("");
    ...
    svg.transition().delay(no_transition ? 0 : 7000).on("end", function () {
        ...
        slide2Group.select(".men-label").attr("x", x(new Date(2017, 1, 1))).attr("y", y(300 / 450 * y.domain()[1])).transition().duration(no_transition ? 0 : 500).style("opacity", 1);
        ...
        case 1:
            ...
            switch (new_step) {
                ...
                case 1:
                    ...
                    d3.select(".women-label").style("fill", colors["Democratic"]).style("opacity", 1);
                ...
                case 2:
                    ...
                    d3.select(".women-label").style("fill", colors["Republican"]).style("opacity", 1);
                    break;
                case 4:
                    // All Representatives
                    yLabel.transition().text("% of Representatives");
